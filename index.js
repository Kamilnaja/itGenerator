...
(() => {
    ...
    class IBAN {
        ...
        generate(prefix, spaces) {
            const unitCode = this.getRandomUnitCode();
            const randomPart = this.getIbanRandomPart();
            const base = '' + unitCode + randomPart;
            const controlSum = this.getIbanControlSumField(base);
        ...
        getRandomUnitCode() {
            var index = Util.getRandomInt(0, this.unitCodes.length - 1);
            return this.unitCodes[index];
        }

        getIbanRandomPart() {
            var randomInt = Util.getRandomInt(0, 9999999999999999);
            return this.addLeadingZeros(randomInt, 16);
        }

        getIbanControlSumField(base) {
            var baseNumber = bigInt(base + '252100');
            var rest = baseNumber.divmod(97);
            var controlNumber = 98 - rest.remainder.value;
            return this.addLeadingZeros(controlNumber, 2);
        }
    ...
    var bigInt = function(e) {
        ...
        function y(e, t, n) {
            var r, i;
            return O(e, t) >= 0 ? r = g(e, t) : (r = g(t, e),
                n = !n),
                r = l(r),
                typeof r == 'number' ? (n && (r = -r),
                    new u(r)) : new o(r, n)
        }
        function b(e, n, r) {
        ...
        function C(e, n) {
            var r = e.length, i = n.length, s = t, o = h(n.length), u = n[i - 1], a = Math.ceil(s / (2 * u)), f = E(e, a), c = E(n, a), p, d, v, m, g, y, b;
            f.length <= r && f.push(0),
                c.push(0),
                u = c[i - 1];
            for (d = r - i; d >= 0; d--) {
        ...
        function A(e, n) {
            ...
            if (e.isSmall)
                return i.isSmall ? [new u(p(s / a)), new u(s % a)] : [J[0], e];
            if (i.isSmall) {
                if (a === 1)
                    return [e, J[0]];
                if (a == -1)
                ...
                if (h < t) {
                    ...
                    var d = r[1];
                    return e.sign && (d = -d),
                        typeof c == 'number' ? (e.sign !== i.sign && (c = -c),
                            [new u(c), new u(d)]) : [new o(c, e.sign !== i.sign), new u(d)]
                }
                a = f(h)
            }
            var v = O(s, a);
            if (v === -1)
                return [J[0], e];
            if (v === 0)
                return [J[e.sign === i.sign ? 1 : -1], J[0]];
            s.length + a.length <= 200 ? r = C(s, a) : r = k(s, a),
                c = r[0];
            var m = e.sign !== i.sign
                , g = r[1]
                , y = e.sign;
            return typeof c == 'number' ? (m && (c = -c),
                c = new u(c)) : c = new o(c, m),
                typeof g == 'number' ? (y && (g = -g),
                    g = new u(g)) : g = new o(g, y),
                [c, g]
        }
        function O(e, t) {
        ...
        function M(e) {
            ...
            if (t.isUnit())
                return !1;
            if (t.equals(2) || t.equals(3) || t.equals(5))
                return !0;
            if (t.isEven() || t.isDivisibleBy(3) || t.isDivisibleBy(5))
                return !1;
            if (t.lesser(25))
                return !0
        }
        ...
        function B(e, t, n) {
            ...
            while (!f || !l)
                s.isZero() ? (f = !0,
                    u.push(r ? 1 : 0)) : r ? u.push(s.isEven() ? 1 : 0) : u.push(s.isEven() ? 0 : 1),
                    o.isZero() ? (l = !0,
                        a.push(i ? 1 : 0)) : i ? a.push(o.isEven() ? 1 : 0) : a.push(o.isEven() ? 0 : 1),
                    s = s.over(2),
                    o = o.over(2);
            var c = [];
        ...
        function I(e, t) {
            return e = $(e).abs(),
                t = $(t).abs(),
                e.equals(t) ? e : e.isZero() ? t : t.isZero() ? e : e.isEven() ? t.isOdd() ? I(e.divide(2), t) : I(e.divide(2), t.divide(2)).multiply(2) : t.isEven() ? I(e, t.divide(2)) : e.greater(t) ? I(e.subtract(t).divide(2), t) : I(t.subtract(e).divide(2), e)
        }
        function q(e, t) {
            return e = $(e).abs(),
                t = $(t).abs(),
                e.multiply(t).divide(I(e, t))
        }
        function R(e, n) {
            e = $(e),
                n = $(n);
            var r = F(e, n)
                ...
                , s = i.subtract(r);
            if (s.isSmall)
                return r.add(Math.round(Math.random() * s));
            ...
            return a = l(a),
                r.add(new o(a, !1, typeof a == 'number'))
        }
        function z(e) {
            var t = e.value;
            return typeof t == 'number' && (t = [t]),
                t.length === 1 && t[0] <= 36 ? '0123456789abcdefghijklmnopqrstuvwxyz'.charAt(t[0]) : '<' + t + '>'
        }
        function W(e, t) {
            t = bigInt(t);
            if (t.isZero()) {
            ...
            if (t.equals(-1))
                return e.isZero() ? '0' : e.isNegative() ? (new Array(1 - e)).join('10') : '1' + (new Array(+e)).join('01');
            var n = '';
            e.isNegative() && t.isPositive() && (n = '-',
                e = e.abs());
            if (t.equals(1))
                return e.isZero() ? '0' : n + (new Array(+e + 1)).join(1);
            var r = [], i = e, s;
            while (i.isNegative() || i.compareAbs(t) >= 0) {
                s = i.divmod(t),
                    i = s.quotient;
                var o = s.remainder;
                o.isNegative() && (o = t.minus(o).abs(),
                    i = i.next()),
                    r.push(z(o))
            }
            return r.push(z(i)),
        ...
        function X(e) {
            ...
            if (i.length === 2) {
                ...
                var f = i[0]
                    , l = f.indexOf('.');
                l >= 0 && (s -= f.length - l,
                    f = f.slice(0, l) + f.slice(l + 1));
                if (s < 0)
                    throw new Error('Cannot include negative exponent part for integers');
                f += (new Array(s + 1)).join('0'),
                    e = f
            }
        ...
        o.prototype.add = function (e) {
            ...
            o.prototype.isPrime = function () {
                ...
                for (a = 0; a < i.length; a++) {
                    ...
                    if (f.equals(J[1]) || f.equals(r))
                        continue;
                    for (u = !0,
                        o = s; u && o.lesser(r); o = o.multiply(2))
                        f = f.square().mod(n),
                            f.equals(r) && (u = !1);
                    if (u)
                        return !1
            ...
            ;
        var _ = [1];
        while (_[_.length - 1] <= t)
            _.push(2 * _[_.length - 1]);
        var D = _.length
            , P = _[D - 1];
        o.prototype.shiftLeft = function (e) {
            if (!H(e))
                return e.isNegative() ? this.shiftRight(e.abs()) : this.times(J[2].pow(e));
            e = +e;
            if (e < 0)
            ...
            o.prototype.shiftRight = function (e) {
                var t;
                if (!H(e))
                    return e.isNegative() ? this.shiftLeft(e.abs()) : (t = this.divmod(J[2].pow(e)),
        ...
        var U = function (e, t) {
            ...
            for (a = f ? 1 : 0; a < e.length; a++) {
                ...
                if (48 <= c && c <= 57)
                    ...
                    do
                        a++;
                    while (e[a] !== '>'); o.push($(e.slice(h + 1, a)))
                }
            }
            o.reverse();
        ...
        o.prototype.toString = function (t) {
            ...
            u.prototype.toString = function (t) {
                return t === e && (t = 10),
                    t != 10 ? W(this, t) : String(this.value)
            }
            ,
    ...
    function generate() {
        ...
        const iban = new IBAN()
        console.log(`IBAN: ${iban.generate('PL')}`);
    }
